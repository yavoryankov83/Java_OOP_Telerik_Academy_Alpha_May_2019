...
public class CreateChair implements Command {
  ...
  public String execute(List<String> parameters) {
    ...
    return createChair(chairType, chairModel, chairMaterial, chairPrice, chairHeight, chairLegs);
  }

  private String createChair(String type, String model, String material, double price, double height, int legs) {
