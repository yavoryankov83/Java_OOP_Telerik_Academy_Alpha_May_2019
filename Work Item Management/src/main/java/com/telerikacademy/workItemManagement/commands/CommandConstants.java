...
public class CommandConstants {
  ...
  // Error messages
  static final String INVALID_NUMBER_OF_ARGUMENTS = "Invalid number of arguments. Expected: %d, Received: %d";
  ...
  static final String TEAM_EXISTS_MESSAGE = "Team %s already exists";
  static final String BOARD_EXISTS_MESSAGE = "Board %s already exists";
  ...
  static final String TEAM_CREATED_SUCCESS_MESSAGE = "Team %s created";
  static final String BOARD_CREATED_SUCCESS_MESSAGE = "Team %s created";
