...
import com.myproject.contracts.PremiumCalculatorByHealthInsurancePlan;
import com.myproject.contracts.PremiumCalculatorByHealthInsurancePlanFactory;
import com.myproject.contracts.PremiumCalculatorByHealthInsurancePlanFactoryImpl;
...
public class BlueCrossBlueShield implements InsuranceBrand {
  ...
  public double computeMonthlyPremium(HealthInsurancePlan insurancePlan, int age, boolean smoking) {
    PremiumCalculatorByHealthInsurancePlanFactory premiumCalculatorByHealthInsurancePlanFactory =
            new PremiumCalculatorByHealthInsurancePlanFactoryImpl();

    PremiumCalculatorByHealthInsurancePlan premiumCalculatorByHealthInsurancePlan =
            premiumCalculatorByHealthInsurancePlanFactory.create(insurancePlan);

    return premiumCalculatorByHealthInsurancePlan.calculate(age, smoking);
